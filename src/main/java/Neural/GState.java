...
public class GState implements Encodable{
    int[][] matrix;
    int botScore;
    ...
    public GState(int[][] m, int b, int op, int nm, ArrayList<ELine> av, boolean bt, ArrayList<ScoreBox> cb, List<Graph.Edge> eL){
        matrix=m;
        botScore=b;
        otherPlayerScore=op;
        numMoves=nm;
    ...
    public Encodable dup() {
        return new GState(matrix.clone(),botScore,otherPlayerScore,numMoves,availLines,botTurn,countBoxes,edgeList);
    }
